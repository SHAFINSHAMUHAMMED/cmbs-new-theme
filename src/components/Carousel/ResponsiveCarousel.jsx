    ...
    <div className={`carousel`}>
      <div className="hidden lg:flex justify-between items-center w-[100%]   ">
        <div className="carousel-card ">
          ...
          >
            <circle cx="37.0324" cy="36.4366" r="36.4366" fill="#F1F0FB" />
            <g clip-path="url(#clip0_2086_4988)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M54.4151 48.8523C54.4151 51.5951 52.1918 53.8184 49.449 53.8184H24.6185C21.8758 53.8184 19.6524 51.5951 19.6524 48.8523L19.6524 24.0218C19.6524 21.2791 21.8758 19.0557 24.6185 19.0557L49.449 19.0557C52.1918 19.0557 54.4151 21.2791 54.4151 24.0218V48.8523ZM49.449 48.8523H26.3741L49.449 25.7776V48.8523Z"
                fill="#1A0060"
              />
            </g>
            <defs>
              <clipPath id="clip0_2086_4988">
                <rect
                  ...
                  height="35.5023"
                  fill="white"
                  transform="translate(19.2813 18.6855)"
                />
              </clipPath>
            </defs>
          </svg>
