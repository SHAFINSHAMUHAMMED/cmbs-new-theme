    ...
    <>
      ...
      <header className="header-section">
        ...
        <div className="hero-sub">
          ...
          <h1 className="hero-headline">Become the <span className="wavy-orange1">Top Pick:</span> Our <span className="text-[#8521F1]">European MBA</span> is <span className="">Your Gateway</span> to <br /> <span className="wavy text-[#8521F1]">High-Paying Careers</span></h1>
          ...
          <img className="hero-right-img-mob" src={heroImgMob} alt="" />
          <div className="hero-right">
           
            <div className="hero-icons-main">
              <img
                className="progress-icon animated-icon-1"
                src={progressIcon}
                alt="progress-icon"
              />
              <img
