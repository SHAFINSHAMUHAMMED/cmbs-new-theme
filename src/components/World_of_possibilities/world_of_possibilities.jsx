      ...
      <div className="world-of-possibilities-brochure ">
        <div className="world-of-possibilities-brochure-left">
          <h1>
            ...
            <span className="wavy-underline-violet">The CMBS MBA</span> <span className="wavy-underline-violet">Brochure</span>
          </h1>
          <p>
